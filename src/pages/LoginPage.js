...
function App({ setUser }){ 
    // setUser : 사용자 정보를 저장하기 위한 setter 메도스
    ...
    const LoginAction = async (event) => { // 로그인과 관련된 이벤트 처리 함수
        ...
        try{
            ...
            // message 에는 '로그인 성공 여부'를 알리는 내용, member에는 로그인 한 사람의 객체 정보가 반환됩니다.
                        ...
                        <Form onSubmit={LoginAction}>
                               ...
                               <Form.Group className="mb-3">
                                ...
                                <Button variant="primary" type="submit" className="w-100">
                                    ...
                                    <Col xs={4}>
                                    <Link to={`/member/signup`} className="btn byn-outline-secondary w-100">
                                        회원가입
                                        </Link>
                                    </Col>
                                </Row>
